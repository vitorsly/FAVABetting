...
public class HorseFactory {
    ...
    public static List<Horse> createStable(){
        ...
        stable.add(createHorse("Sparky", "the little foal that could",          18, 60, 12.7,1, 14));
        ...
        stable.add(createHorse("Firebrand", "the cocky redmane",                22, 60, 7.2,3, 21));
        ...
        stable.add(createHorse("Nightmare", "the terrifying dread stallion",    32, 70, 4.4,7,31));
        ...
        stable.add(createHorse("Fluffy", "the sweetest unicorn",                15, 40, 30,0,6));
        ...
        stable.add(createHorse("Carnage", "the wave of destruction",            27, 50, 5,2,10));
        ...
        stable.add(createHorse("Luna", "the mysterious lunar mare",             16, 100, 15,0,3));
        ...
        stable.add(createHorse("Boink", "the clumsy boy who tried",             12, 20, 50,0,48));
        ...
        stable.add(createHorse("Tracy", "the clumsy girl who could",            14, 20, 30,1,24));
        ...
        stable.add(createHorse("Norris", "the undisputed champion",             40, 120, 2,10,20));
        ...
        stable.add(createHorse("The-Spork", "the three pronged beetle",         18, 33, 13,0,3));
        ...
        stable.add(createHorse("X-10", "the equine terminator",                 35, 90, 4,0,0));
