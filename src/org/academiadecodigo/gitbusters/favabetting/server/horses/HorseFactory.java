...
public class HorseFactory {
    ...
    public static List<Horse> createStable(){
        ...
        stable.add(createHorse("Bolt", "the quick white horse",                 28, 50, 5.5, 5, 25));
        stable.get(0).setTrackModifiers(1, 1.2, 0.8, 0.7);
        ...
        stable.add(createHorse("Lightning", "the brash pale stallion",          30, 50, 5,7,29));
        stable.get(1).setTrackModifiers(1, 1.2, 0.8, 0.8);
        ...
        stable.add(createHorse("Thunder", "the agile old horse",                23, 40, 6.75,10,50));
        stable.get(2).setTrackModifiers(1, 1.2, 0.8, 0.7);
        stable.get(2).setWeatherModifiers(1.1, 1, 0.75, 0.90, 0.8, 0.9, 0.85);
        ...
        stable.add(createHorse("Sparky", "the little foal that could",          20, 60, 12.7,1, 14));
        stable.get(3).setTrackModifiers(1.1, 1.1, 1.1, 0.7);
        ...
        stable.add(createHorse("Firebrand", "the cocky redmane",                23, 60, 7.2,3, 21));
        stable.get(4).setTrackModifiers(1.1, 0.9, 1.3, 0.6);
        ...
        stable.add(createHorse("Nightmare", "the terrifying dread stallion",    32, 70, 4,7,31));
        stable.get(5).setTrackModifiers(0.8, 1.1, 0.9, 0.7);
        ...
        stable.add(createHorse("Fluffy", "the sweetest unicorn",                17, 40, 30,0,6));
        stable.get(6).setTrackModifiers(1.4, 1, 0.7, 0.9);
        ...
        stable.add(createHorse("Carnage", "the wave of destruction",            28, 50, 5,2,10));
        stable.get(7).setTrackModifiers(0.9, 1.1, 0.9, 0.9);
        stable.get(7).setWeatherModifiers(1.0, 0.9, 0.8, 0.8, 1.0, 1.0, 1.0);
        ...
        stable.add(createHorse("Tora", "fast as the wind",                      24, 50, 6.8,6,41));
        stable.get(8).setTrackModifiers(1.1, 1.3, 0.7, 1);
        stable.get(8).setWeatherModifiers(1.2, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9);
        stable.get(8).setBigDescription("Tora, his name was Tora, runs fast as the wind, especially over dirt paths.");
        stable.add(createHorse("Skyborne", "the winged hussar",                 22, 60, 7.5,5,38));
        stable.get(9).setTrackModifiers(1, 1, 1, 1);
        stable.get(9).setWeatherModifiers(0.7, 0.8, 0.9, 1, 0.9, 0.9, 0.9);
        ...
        stable.add(createHorse("Luna", "the mysterious lunar mare",             20, 100, 15,0,3));
        stable.get(10).setTrackModifiers(1.1, 1.2, 0.8, 0.9);
        stable.get(10).setWeatherModifiers(0.95, 0.9, 0.9, 0.75, 0.9, 0.95, 1.3);
        ...
        stable.add(createHorse("Flash", "the undefeated",                       30, 100, 3,1,1));
        stable.get(11).setTrackModifiers(0.9, 1.3, 0.7, 0.6);
        stable.get(11).setWeatherModifiers(1, 0.8, 1, 1.1, 0.9, 0.9, 0.9);
        ...
        stable.add(createHorse("Boink", "the clumsy boy who tried",             15, 20, 50,0,48));
        stable.get(12).setTrackModifiers(1.1, 1.2, 0.7, 0.9);
        ...
        stable.add(createHorse("Tracy", "the clumsy girl who could",            17, 20, 30,1,24));
        stable.get(13).setTrackModifiers(1.1, 1.1, 0.9, 0.9);
        ...
        stable.add(createHorse("Norris", "the undisputed champion",             36, 120, 1.5,10,20));
        stable.get(14).setTrackModifiers(1, 1, 1, 1);
        ...
        stable.add(createHorse("The-Spork", "the three pronged beetle",         20, 33, 13,0,3));
        stable.get(15).setTrackModifiers(1.2, 1.2, 0.8, 1);
        ...
        stable.add(createHorse("Shadow", "the best kept secret",                24, 45, 6.5,0,0));
        stable.get(16).setTrackModifiers(1, 1.1, 0.8, 0.8);
        ...
        stable.get(17).setTrackModifiers(1, 1.2, 0.8, 0.8);
        ...
        stable.add(createHorse("Frost", "the coolest beast",                    25, 45, 6.4,5,33));
        stable.get(18).setTrackModifiers(1, 1.1, 0.7, 1.2);
        ...
        stable.add(createHorse("X-10", "the equine terminator",                 34, 90, 3,0,0));
        stable.get(19).setTrackModifiers(1, 1, 0.9, 0.7);
        stable.get(19).setWeatherModifiers(1, 0.6, 1, 1, 0.9, 1, 1);
