...
public class HorseFactory {
    ...
    public static List<Horse> createStable(){
        ...
        stable.add(createHorse("Thunder", "the agile old horse",                22, 40, 6.75,10,50));
        ...
        stable.add(createHorse("Firebrand", "the cocky redmane",                20, 60, 7.2,3, 21));
        ...
        stable.add(createHorse("Nightmare", "the terrifying dread stallion",    35, 70, 4.4,7,31));
        ...
        stable.add(createHorse("Fluffy", "the sweetest unicorn",                12, 40, 30,0,6));
        ...
        stable.add(createHorse("Tora", "fast as the wind",                      23, 50, 6.8,6,41));
        ...
        stable.add(createHorse("Luna", "the mysterious lunar mare",             15, 100, 15,0,3));
        ...
        stable.add(createHorse("Boink", "the clumsy boy who tried",             10, 20, 50,0,48));
        ...
        stable.add(createHorse("Tracy", "the clumsy girl who could",            12, 20, 30,1,24));
        ...
        stable.add(createHorse("Norris", "the undisputed champion",             50, 120, 2,10,20));
        ...
        stable.add(createHorse("The-Spork", "the three pronged beetle",         17, 33, 13,0,3));
        ...
        stable.add(createHorse("X-10", "the equine terminator",                 38, 90, 4,0,0));
